import { CELL, cellPx, MAIN_PATH, HOME_COL, HOME_BASE, HOME_START, FINISHED, PATH_ENTRY } from '../constants/Board';
import { PLAYER_COLORS } from '../constants/Colors';
export class Piece {
    constructor(scene, color, idx) {
        this.piecePos = -1; // -1=base, 0-51=anel, 52-56=coluna, 57=finished
        this.scene = scene;
        this.color = color;
        this.idx = idx;
    ...
    async animateThrough(positions) {
